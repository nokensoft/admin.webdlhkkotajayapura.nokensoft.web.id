<div id="informasi-lingkungan" class="rs-degree style1 modify mt-100 pb-70 md-pb-40">
    <div class="container">
        ...
        <div class="row y-middle">
            ...
            {{-- <div class="col-lg-4 col-md-6 mb-30">
                <div class="degree-wrap">
                    <img src="{{ asset('assets/visitor/assets/images/dlhk/informasi-lingkungan/2.jpg') }}" alt="">
                    <div class="title-part mt-0">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="degree-wrap">
                    <img src="{{ asset('assets/visitor/assets/images/dlhk/informasi-lingkungan/3.jpg') }}" alt="">
                    <div class="title-part mt-0">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="degree-wrap">
                    <img src="{{ asset('assets/visitor/assets/images/dlhk/informasi-lingkungan/4.jpg') }}" alt="">
                    <div class="title-part mt-0">
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="degree-wrap">
                    <img src="{{ asset('assets/visitor/assets/images/dlhk/informasi-lingkungan/1.jpg') }}" alt="">
                    <div class="title-part mt-0">
