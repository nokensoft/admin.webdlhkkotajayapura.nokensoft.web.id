    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 pl-60 md-pl-15">
            ...
            <div class="sec-title4 text-center mb-45">
                <div class="sub-title">Permohonan Data</div>
                <h2 class="title black-color">Tahapan Permintaan Data</h2>
                <div class="new-desc">Kini kami telah menyediakan layanan online bagi masyarakat dan organisasi umum yang memerlukan data-data terkait lingkungan hidup.</div>
            </div>
            <!-- heading end -->
