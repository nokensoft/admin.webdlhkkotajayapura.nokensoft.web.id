...
<div class="inbox-leftbar">
        @if(Auth::user()->hasRole(['administrator','author']))
            <a href="{{ url('dasbor/slider/create') }}" class="btn btn-primary shadow d-block mb-2 waves-effect waves-light">
                <i class="mdi mdi-plus-box me-2"></i> Tambah
            </a>
        @endif
            <ul class="list-group">
                    <a href="{{ url('dasbor/slider') }}" class="list-group-item list-group-item-action @if(request()->segment(3) == '') active @endif">
                    ...
                    <a href="{{ url('dasbor/slider/draft') }}" class="list-group-item list-group-item-action @if(request()->segment(3) == 'draft') active @endif">
                    ...
                    <a href="{{ url('dasbor/slider/trash') }}" class="list-group-item list-group-item-action">
