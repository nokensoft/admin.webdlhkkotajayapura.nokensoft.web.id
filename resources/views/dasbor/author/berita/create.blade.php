            ...
            <div class="row">
                <div class="card">
                   <div class="col-lg-12">
                        <div class="card-body">
                            <h1></h1>
                            <form action="{{route('dasbor.berita.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            {!! Form::text('title',null,['required','id'=>'title','class'=>'form-control','placeholder'=>'Judul Berita ']) !!}
                                        </div>
                                        <div class="mb-3">
